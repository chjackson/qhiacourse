---
title: Uncertainty in quantitative health impact modelling: practicals
...
Suppose we want to estimate the following parameters to include in a health impact model.

In an ideal world where we can measure anything, what would we measure, on what individuals?  How would we summarise the individual-level measurements to estimate the parameter? 

* background/baseline exposure to PM2.5

* relative risk of lung cancer for one unit increase in exposure to PM2.5
...
<!-- Mine Anna's paper for harder examples -->
